...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
			<a href="javascript:openTab('写科普信息','writeNews.jsp','icon-writenews')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-writenews'" style="width: 150px">写科普信息</a>
		...
		<div title="科普信息管理"  data-options="iconCls:'icon-bkgl'" style="padding:10px;">
			<a href="javascript:openTab('写科普信息','writeNews.jsp','icon-writenews')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-writenews'" style="width: 150px;">写科普信息</a>
			<%--<a href="javascript:openTab('科普信息信息管理','newsManage.jsp','icon-bkgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">科普信息信息管理</a>--%>
		</div>
		<%--<div title="科普信息类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">--%>
		<%--	<a href="javascript:openTab('科普信息类别信息管理','newsTypeManage.jsp','icon-bklb')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">科普信息类别信息管理</a>--%>
		<%--</div>--%>
