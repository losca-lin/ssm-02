    ...
    <table style="padding: 5px" width="100%">
        <tr>
            ...
            <td valign="bottom" align="right" width="50%">
                ...
                <a href="javascript:indexout()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-exit'"
                   style="width: 150px;">返回浏览页</a>
            </td>
        </tr>
    </table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
            <a href="javascript:openTab('写科普信息','writeNews.jsp','icon-writenews')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writenews'" style="width: 150px">写科普信息</a>
        ...
        <div title="科普信息管理" data-options="iconCls:'icon-bkgl'" style="padding:10px;">
            <a href="javascript:openTab('写科普信息','writeNews.jsp','icon-writenews')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writenews'" style="width: 150px;">写科普信息</a>
            <a href="javascript:openTab('科普信息信息管理','newsManage.jsp','icon-bkgl')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">科普信息信息管理</a>
        </div>
        <div title="科普信息类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
            <a href="javascript:openTab('科普信息类别信息管理','newsTypeManage.jsp','icon-bklb')"
               class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'"
               style="width: 150px;">科普信息类别信息管理</a>
        </div>
        ...
        <div title="用户管理" data-options="iconCls:'icon-plgl'" style="padding:10px">
            <a href="javascript:openTab('管理用户','userManage.jsp','icon-review')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-review'" style="width: 150px">管理用户</a>
        </div>
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:200px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>用户名：</td>
                <td><input type="text" id="userName" name="name" readonly="readonly"
                           value="${sessionScope.loginNewsperson.name }" style="width: 200px"/></td>
            </tr>
            <tr>
                <td>新密码：</td>
