...
<script type="text/javascript">
	...
	function openNewsTypeAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加科普信息类别信息");
	...
	function openNewsTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#dlg").dialog("open").dialog("setTitle","编辑科普信息类别信息");
		 $("#fm").form("load",row);
...
<table id="dg" title="科普信息类别管理" class="easyui-datagrid"
   ...
   <thead>
   	<tr>
   		...
   		<th field="typeName" width="100" align="center">科普信息类型名称</th>
